                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <div className="flex flex-col items-center ms-3">
                                ...
                                <div
                                    className={`z-50 ${isUserMenuOpen ? "flex" : "hidden"} absolute top-12 right-2 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow`}
                                >
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Daily Lesson</span>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Grammar Test</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Writing Test</span>
                            </Link>
                        </li>
                        <li>
                            <Link
